...
static void test_naive_matrix_num_mult()
{
...
static void test_naive_matrix_matrix_mult()
{
    struct matrix* A = init_matrix(3, 3);
    struct matrix* B = init_matrix(3, 3);
    ...
    naive_matrix_matrix_mult(A, B, C);
...
static void test_naive_matrix_matrix_add()
{
    struct matrix* A = init_matrix(3, 3);
    struct matrix* B = init_matrix(3, 3);
    struct matrix* C = init_matrix(3, 3);
...
static void test_wrong_dimensions()
{
    ...
    assert(naive_gemm(1.0, 2.0, A, B, C, D) == -1);
    free_matrix(A);
    free_matrix(B);
    free_matrix(C);
    free_matrix(D);
...
int main()
{
    test_naive_matrix_num_mult();
    test_naive_matrix_matrix_mult();
    test_naive_matrix_matrix_add();
    test_naive_gemm();
